...
public class ONTAddView extends VerticalLayout {
    ...
    public ONTAddView(SshService sshService, OntService ontService, OltService oltService, CommandHistoryService commandHistoryService, FrameService frameService, SlotService slotService, PortService portService, LineProfileService lineProfileService, ServiceProfileService serviceProfileService) {
        ...
        button.addClickListener(clickEvent -> {
            ...
            //code to run ssh
            String com="ont add 10 29 sn-auth " + ontComboBox.getValue().getSerialNumber() + " omci ont-lineprofile-id " + lineProfileComboBox.getValue().getProfileID() + " ont-srvprofile-id " + serviceProfileComboBox.getValue().getProfileID() + "desc OltManager";
